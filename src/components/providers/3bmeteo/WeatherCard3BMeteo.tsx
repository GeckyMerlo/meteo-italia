...
import WeatherDetailsModal3BMeteo from './WeatherDetailsModal3BMeteo';
...
interface WeatherCard3BMeteoProps {
  weatherData: WeatherData;
  loading?: boolean;
}

const WeatherCard3BMeteo: React.FC<WeatherCard3BMeteoProps> = ({ weatherData, loading }) => {
    ...
    <>
      <div 
        className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-all duration-300 border-2 ${
          status === 'success' 
            ? 'border-transparent hover:border-blue-300 dark:hover:border-blue-500 cursor-pointer hover:shadow-xl transform hover:scale-105' 
...
export default WeatherCard3BMeteo;

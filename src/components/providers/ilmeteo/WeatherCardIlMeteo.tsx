...
import WeatherDetailsModalIlMeteo from './WeatherDetailsModalIlMeteo';
...
interface WeatherCardIlMeteoProps {
  weatherData: WeatherData;
  loading?: boolean;
}

const WeatherCardIlMeteo: React.FC<WeatherCardIlMeteoProps> = ({ weatherData, loading }) => {
    ...
    <>
      <div 
        className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-all duration-300 border-2 ${
          status === 'success' 
            ? 'border-transparent hover:border-green-300 dark:hover:border-green-500 cursor-pointer hover:shadow-xl transform hover:scale-105' 
...
export default WeatherCardIlMeteo;
